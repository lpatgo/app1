...
const NavBar = () => {
    return (
      <div className="navzone fixed w-full top-0 h-20 z-10 border-b border-gray-200 bg-opacity-20 shadow-lg flex items-center px-5 bg-[rgba(103,116,131,0.20)]">
        <div className="logo bg-cover bg-no-repeat bg-center h-14 w-16" style={{ backgroundImage: "url('/pusher-atlas-globe-colors1.gif')" }}>
        </div>
        <h1 className="title mt-2 ml-7 text-xl font-semibold uppercase text-left text-gray-800">Survivor Atlas</h1>
